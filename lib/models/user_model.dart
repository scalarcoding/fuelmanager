...
class AppUserData {
  ...
  static Future<AppUserData?> fromSharedPreferences(
      SharedPreferences prefs) async {
    final prefList = await prefs.getStringList('userdata');
    return AppUserData(
      ID: prefList![0],
      name: prefList[1],
      email: prefList[2],
...
class AppUserCredential {
  ...
  static Future<AppUserCredential> fromSharedPreferences(
      SharedPreferences prefs) async {
    final prefList = await prefs.getStringList('credentials');
